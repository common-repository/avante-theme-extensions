 ...
 */
class Avante_Support_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 
            'classname' => 'avante-support-widget', 
            'description' => __('Add a support option to the Customer Support section of the One-Page Template.', 'avante-lite'),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'avante_support', __('Avante Support Widget', 'avante-lite'), $widget_ops );
    ...
    ?>
    <p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Support Title', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('style'); ?>"><?php esc_html_e('Support Icon Style', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e('Support Icon Name', 'avante-lite'); ?></label>
    ...
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'color' ); ?>" style="width:100%;display:inline-block;"><?php esc_html_e('Support Icon Color', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php esc_html_e('Support Icon Image', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('textarea'); ?>"><?php esc_html_e('Support Description', 'avante-lite'); ?></label>
...
add_action( 'widgets_init', function() {
    register_widget( 'Avante_Support_Widget' );
} );
?>