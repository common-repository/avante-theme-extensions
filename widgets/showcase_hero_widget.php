 ...
 */
class Avante_Showcase_Hero_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 
            'classname' => 'avante-showcase-hero-widget',
            'description' => __('Add a showcase detail to the Showcase section of the One-Page Template.', 'avante-lite') 
        );
        parent::__construct( 'avante_showcase_hero', __('Avante Showcase Hero Widget', 'avante-lite'), $widget_ops );
    ...
    function widget( $args, $instance ) {
        ...
        if( $bg_image_url) {
            echo '<img src="'. esc_url($bg_image_url). '" class="widget-bg-image">';
        }
        // content wrapper
        ...
        if( $btn_text && $btn_url ) {
            echo '<a href="'.esc_url($btn_url).'" class="btn btn-pill btn-lg btn-outline">'.esc_html($btn_text).'</a>';
        }
        echo '</div>';
        echo $after_widget;
    }
    ...
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'color' ); ?>"><?php esc_html_e('Showcase Icon Color', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('bg_image_url'); ?>"><?php esc_html_e('Showcase Background Image', 'avante-lite'); ?></label>
        <br /><i><?php esc_html_e('Upload background image for a widget.', 'avante-lite'); ?></i>
        <input id="<?php echo $this->get_field_id('bg_image_url'); ?>" type="text" class="image-url" name="<?php echo $this->get_field_name('bg_image_url'); ?>" value="<?php echo esc_url($instance['bg_image_url']); ?>" style="width: 100%;" />
        <input data-title="Image in Widget" data-btntext="Select it" class="button upload_image_button" type="button" value="<?php esc_html_e('Upload','avante-lite') ?>" />
        <input data-title="Image in Widget" data-btntext="Select it" class="button clear_image_button" type="button" value="<?php esc_html_e('Clear','avante-lite') ?>" />
    </p>
    <p class="img-prev">
        <img src="<?php echo esc_url($instance['bg_image_url']); ?>" style="max-width: 100%;">
    </p>
    <p>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('btn_text'); ?>"><?php esc_html_e('Showcase Button Text', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('btn_url'); ?>"><?php esc_html_e('Showcase Button URL', 'avante-lite'); ?></label>
...
add_action( 'widgets_init', function() {
    register_widget( 'Avante_Showcase_Hero_Widget' );
} );
?>
