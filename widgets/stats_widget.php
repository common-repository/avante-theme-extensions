 ...
 */
class Avante_Stats_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 
            'classname' => 'avante-stats-widget', 
            'description' => __('Add stats to the About section of the One-Page Template.', 'avante-lite') 
        );
        parent::__construct( 'avante_stats', __('Avante Stats Widget', 'avante-lite'), $widget_ops );
    ...
    function widget( $args, $instance ) {
        ...
        if( $icon_name ) {
            echo '<i class="'.esc_attr($style).' fa-'.esc_attr($icon_name).' fa-6x mr-4 icon" style="color:'.esc_attr($color).' !important;"></i>';
        }
        if( !$icon_name && $icon_image_url) {
            echo '<img src="'.esc_url($icon_image_url).'" class="icon mr-4">';
        }
    ...
    ?>
    <p>
        <label for="<?php echo $this->get_field_id('style'); ?>"><?php esc_html_e('Stats Icon Style', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon_name'); ?>"><?php esc_html_e('Stats Icon Name', 'avante-lite'); ?></label>
    ...
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'color' ); ?>" style="width: 100%;display:inline-block;"><?php esc_html_e('Stats Icon Color', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon_image_url'); ?>"><?php esc_html_e('Stats Icon Image', 'avante-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Stats Number', 'avante-lite'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('textarea'); ?>"><?php esc_html_e('Stats Description', 'avante-lite'); ?></label>
...
add_action( 'widgets_init', function() {
    register_widget( 'Avante_Stats_Widget' );
} );
?>